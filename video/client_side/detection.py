...
class Detection(QThread):
	...
	def run(self):
		...
		# Loads Yolov4
		net = cv2.dnn.readNet("/Users/adi/Downloads/AlertNow/client_side/weights/yolov3.weights", "/Users/adi/Downloads/AlertNow/client_side/cfg/yolov3.cfg")
		classes = []

		# Loads object names
		with open("/Users/adi/Downloads/AlertNow/client_side/obj.names", "r") as f:
			...
			if ret:
				...
				for out in outs:
					for detection in out:
						...
						# If detection confidance is above 75% a weapon was detected
						if confidence > 0.75:
				...
				for i in range(len(boxes)):
					if i in indexes:
						...
						cv2.putText(frame, label + " {0:.1%}".format(confidence), (x, y - 20), font, fontScale=4, color=color, thickness=5)
